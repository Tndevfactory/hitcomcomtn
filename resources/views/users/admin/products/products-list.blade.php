...
<div class=' mt-3 px-3  row '> 
    <div class=' col fs-3  text-center'> 
      <h3 class=' col fs-3 fw-bold text-primary text-uppercase'> {{ __('manage products') }}</h3>
    </div> 
</div>
...
<div class='  d-flex justify-content-between mt-3 px-3'> 
    ...
    class='btn fw-bold btn-primary  ' >  <i class="fa-solid fa-circle-plus"></i> {{ __('add product') }} </a> 
</div>
