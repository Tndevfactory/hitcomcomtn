...
<div class=' mt-3 px-3  row '> 
    <div class=' col fs-3  text-center'> 
      <h3 class=' col fs-3 fw-bold text-primary text-uppercase'> {{ __('add category') }}</h3>
    </div> 
</div>

<div class='  d-flex justify-content-end mt-3 px-3'> 
    <a href="{{ route('admin-categories-list', [ 'language' => Request()->language, 'id' => Auth()->user()->id ]) }}" 
    class='btn fw-bold btn-primary ms-auto' > <i class="fa-solid fa-circle-left"></i>  {{ __('manage categories') }} </a> 
</div>
