...
<div class=' mt-3 px-3  row '> 
    <div class=' col fs-3  text-center'> 
      <h3 class=' col fs-3 fw-bold text-primary text-uppercase'> {{ __('manage coupons') }}</h3>
    </div> 
</div>
...
<div class='  d-flex justify-content-between mt-3 px-3'> 
    ...
    <a href="{{ route('admin-coupon-add', [ 'language' => Request()->language, 'id' => Auth()->user()->id ]) }}" 
    class='btn fw-bold btn-primary ms-auto' ><i class="fa-solid fa-circle-plus"></i> {{ __('add coupons') }} </a> 
</div>
