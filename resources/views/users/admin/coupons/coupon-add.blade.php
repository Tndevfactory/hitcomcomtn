...
<div class='  d-flex justify-content-end mt-3 px-3'> 
    <a href="{{ route('admin-coupons-list', [ 'language' => Request()->language, 'id' => Auth()->user()->id ]) }}" 
    class='btn fw-bold btn-primary ms-auto' > <i class="fa-solid fa-circle-left"></i>  {{ __('manage coupons') }} </a> 
</div>
