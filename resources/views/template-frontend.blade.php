...
<html lang="en">
  <head>
    ...
    <title>HITCOM Shop</title>
    <meta content="" name="description" />
    <meta content="" name="keywords" />

    <!-- Favicons -->
    <link href="template-frontend/assets/img/favicon.png" rel="icon" />
    <link href="template-frontend/assets/img/apple-touch-icon.png" rel="apple-touch-icon" />
    ...
    <!-- Vendor CSS Files -->
    <link
      href="template-frontend/assets/vendor/bootstrap/css/bootstrap.min.css"
      rel="stylesheet"
    />
    <link
      href="template-frontend/assets/vendor/bootstrap-icons/bootstrap-icons.css"
      rel="stylesheet"
    />
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <body>
      ...
      <section id="contact" class="contact">
        <div class="container">
          ...
          <div class="row justify-content-center">
            <div class="col-lg-10">
              <form
                action="template-frontend/forms/contact.php"
                method="post"
                role="form"
    ...
    <footer id="footer">
      <div class="container">
        <div class="copyright">
          &copy; Copyright <strong><span>ComingSoon</span></strong
          >. All Rights Reserved tndev art
        </div>
    ...
    <script src="atemplate-frontend/assets/vendor/php-email-form/validate.js"></script>
